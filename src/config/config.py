...
from .hessian_approximation_config import (
    HessianApproximationConfig,
    HessianName,
    KFACBuildConfig,
)
from .model_config import LinearModelConfig, MLPModelConfig, ModelConfig
...
class Config:
    ...
    def model_training_dataset_hash(
        ...
        hessian_approx_config: KFACBuildConfig | None = None,
        length: int = 10,
    ) -> str:
