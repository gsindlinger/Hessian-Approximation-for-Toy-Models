...
CREATE TABLE IF NOT EXISTS results (
    ...
    regularization_value      REAL,
    regularization_strategy   TEXT,
...
def append_result(
    ...
    *,
    ...
    regularization_value: Optional[float] = None,
    regularization_strategy: Optional[str] = None,
    ...
    cur = con.execute(
        """INSERT OR REPLACE INTO results
              (run_id, model_id, epoch, config_hash, model_hash, code_sha,
               ...
               collector_subset_size, regularization_value, regularization_strategy,
               pseudo_target_strategy, pseudo_target_repetitions,
               vector_num_samples, sampling_method, comparison_probe_source,
               damping, pseudo_inverse_factor, num_parameters,
