...
from deleuze.utils.loss import loss_wrapper_with_apply_fn


@dataclass
class Hessian(HessianComputer):
    ...
    def compare_hessians(
        ...
        raise NotImplementedError("Hessian comparison not implemented yet.")
    ...
    def _compute_hvp_batched(
        ...
        return jax.vmap(
            lambda v: Hessian._compute_hvp_single(compute_context, v, damping)
        )(vectors)
    ...
    def compute_ihvp_batched(
        ...
        """
        # Vectorize over the batch dimension
        hessian = Hessian._compute_hessian(compute_context, damping)
