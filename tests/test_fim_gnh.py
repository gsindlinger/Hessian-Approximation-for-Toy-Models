...
class TestFIMGaussNewton:
    ...
    def random_regression_config(self):
        ...
        return Config(
            ...
            model=LinearModelConfig(loss="mse", hidden_dim=[10]),
    ...
    def test_fim_gnh_comparison_classification(
        ...
        assert jnp.allclose(fim_hessian, gnh_hessian, atol=0.2)
    ...
    #     max_abs_diff = jnp.max(jnp.abs(fim_hessian - gnh_hessian))
    #     print(f"Max absolute difference between FIM and GNH Hessians: {max_abs_diff}")
